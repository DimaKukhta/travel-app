...
class Gallery extends React.Component {
    ...
    render() {
        return ( <
            ...
            input className = "app-interval-input"
            type = "text"
            onChange = {
            ...
            /span> <
            select className = "app-interval-input"
            ...
            li >
            <
            input id = "show_fullscreen"
            type = "checkbox"
            onChange = {
                this._handleCheckboxChange.bind(
                    this,
                    "showFullscreenButton"
                )
            }
            ...
            li >
            <
            input id = "slide_on_thumbnail_hover"
            type = "checkbox"
            onChange = {
                this._handleCheckboxChange.bind(
                    this,
